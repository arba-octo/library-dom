...
export const dataBooks = [
    {
        ...
        pages: 192,
        age: [4, 10],
        faceImg: [roboltsPreview, roboltsFace],
        tocImg: [[roboltsTocSm], [roboltsToc]],
        exampleImg: [roboltsExampSm, roboltsExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
    ...
    },
    {
        ...
        pages: 128,
        age: [3, 8],
        faceImg: [dragonsEncicPreview, dragonsEncicFace],
        tocImg: [null, null],
        exampleImg: [dragonsEncicExampSm, dragonsEncicExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: false,
    ...
    },
    {
        ...
        pages: 124,
        age: [1, 7],
        faceImg: [talesAndPicPreview, talesAndPicFace],
        tocImg: [[talesAndPicTocSm], [talesAndPicToc]],
        exampleImg: [talesAndPicExampSm, talesAndPicExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
    ...
    },
    {
        ...
        pages: 224,
        age: [2, 7],
        faceImg: [mumytrollsPreview, mumytrollsFace],
        tocImg: [[mumytrollsTocSm], [mumytrollsToc]],
        exampleImg: [mumytrollsExampSm, mumytrollsExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: true,
    ...
    },
    {
        ...
        pages: 414,
        age: [7, 13],
        faceImg: [harmAdvice400OsterPreview, harmAdvice400OsterFace],
        tocImg: [null, null],
        exampleImg: [harmAdviceOsterExampSm, harmAdviceOsterExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: false,
    ...
    },
    {
        ...
        pages: 384,
        age: [6, 13],
        faceImg: [kiplingPreview, kiplingFace],
        tocImg: [[kiplingTocSm], [kiplingToc]],
        exampleImg: [kiplingExampSm, kiplingExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: false,
    ...
    },
    {
        ...
        id: 7,
        author: 'Дале Ш.',
        collection: 'Земляничная Фея',
        pages: 48,
        age: [3, 7],
        faceImg: [zemlFeyaAmazingSpellsPreview, zemlFeyaAmazingSpellsFace],
        tocImg: [[zemlFeyaAmazingSpellsTocSm], [zemlFeyaAmazingSpellsToc]],
        exampleImg: [zemlFeyaAmazingSpellsExampSm, zemlFeyaAmazingSpellsExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: false,
    ...
    },
    {
        ...
        pages: 48,
        age: [3, 7],
        faceImg: [zemlFeya3WildbPreview, zemlFeya3WildbFace],
        tocImg: [[zemlFeya3WildbTocSm], [zemlFeya3WildbToc]],
        exampleImg: [zemlFeya3WildbExampSm, zemlFeya3WildbExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: false,
    ...
    },
    {
        ...
        pages: 32,
        age: [1, 7],
        faceImg: [shmyakToDoctorPreview, shmyakToDoctorFace],
        tocImg: [null, null],
        exampleImg: [shmyakToDoctorExampSm, shmyakToDoctorExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: true,
    ...
    },
    {
        ...
        pages: 320,
        age: [6, 10],
        faceImg: [newChildEncicPreview, newChildEncicFace],
        tocImg: [[newChildEncicToc1Sm, newChildEncicToc2Sm, newChildEncicToc3Sm, newChildEncicToc4Sm], [newChildEncicToc1, newChildEncicToc2, newChildEncicToc3, newChildEncicToc4]],
        exampleImg: [newChildEncicExampSm, newChildEncicExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: false,
    ...
    },
    {
        ...
        pages: 63,
        age: [3, 7],
        faceImg: [myEmotions20TalesPreview, myEmotions20TalesFace],
        tocImg: [[myEmotions20TalesTocSm], [myEmotions20TalesToc]],
        exampleImg: [myEmotions20TalesExampSm, myEmotions20TalesExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: false,
    ...
    },
    {
        ...
        pages: 31,
        age: [1, 7],
        faceImg: [shmyakGoodNightPreview, shmyakGoodNightFace],
        tocImg: [null, null],
        exampleImg: [shmyakGoodNightExampSm, shmyakGoodNightExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: true,
    ...
    },
    {
        ...
        pages: 100,
        age: [4, 10],
        faceImg: [childEncicDinosaurusPreview, childEncicDinosaurusFace],
        tocImg: [[childEncicDinosaurusTocSm], [childEncicDinosaurusToc]],
        exampleImg: [childEncicDinosaurusExampSm, childEncicDinosaurusExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: false,
    ...
    },
    {
        ...
        pages: 160,
        age: [4, 10],
        faceImg: [harmAdvOsterPreview, harmAdvOsterFace],
        tocImg: [null, null],
        exampleImg: [harmAdvOsterExampSm, harmAdvOsterExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: false,
    ...
    },
    {
        ...
        author: 'Вебб Х.',
        collection: 'Мейзи Хитчинс. Приключения девочки-детектива',
        pages: 124,
        age: [6, 12],
        faceImg: [meiziSecretBoyFromJungPreview, meiziSecretBoyFromJungFace],
        tocImg: [null, null],
        exampleImg: [meiziSecretBoyFromJungExampSm, meiziSecretBoyFromJungExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: false,
    ...
    },
    {
        ...
        pages: 144,
        age: [4, 7],
        faceImg: [zokiBadaPreview, zokiBadaFace],
        tocImg: [[zokiBadaTocSm], [zokiBadaToc]],
        exampleImg: [zokiBadaExampSm, zokiBadaExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: false,
    ...
    },
    {
        ...
        pages: 143,
        age: [4, 10],
        faceImg: [tripToFlfsKingdomPreview, tripToFlfsKingdomFace],
        tocImg: [null, null],
        exampleImg: [tripToFlfsKingdomExampSm, tripToFlfsKingdomExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: false,
    ...
    },
    {
        ...
        pages: 31,
        age: [1, 7],
        faceImg: [shmyakSeaHistPreview, shmyakSeaHistFace],
        tocImg: [null, null],
        exampleImg: [shmyakSeaHistExampSm, shmyakSeaHistExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: true,
    ...
    {
        id: 19,
        title: 'Спящая красавица. Кот в сапогах',
        author: 'Перро Ш.',
        collection: null,
        pages: 47,
        age: [3, 8],
        faceImg: [peroSleepBeautyAndCatInBootsPreview, peroSleepBeautyAndCatInBootsFace],
        tocImg: [[peroSleepBeautyAndCatInBootsTocSm], [peroSleepBeautyAndCatInBootsToc]],
        exampleImg: [peroSleepBeautyAndCatInBootsExampSm, peroSleepBeautyAndCatInBootsExamp],
        statusFree: true,
        occupiedTo: null,
        owner: 'DanaArb',
        firstSelfReading: false,
